...
function generatePassword() {
  ...
  for(var i = 0; i < passwordLength; i++) {
    ...
    password = password + randomArray[randomCharacter];
  }
  return password;
}
...
function passwordChoice () {
  randomArray = [];
passwordLength = window.prompt("Please choose a number between 8 and 128 for your password length.");
...
function writePassword() {
  var promptChoices = passwordChoice();
  if(promptChoices) {
